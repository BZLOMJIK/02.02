...
/** Урок 8. Задание 5. Чат-бот компании «Собираем и перерабатываем». */
public class Practicum {
    ...
    public static void main(String[] args) {
        ...
        switch (command) {
            ...
            case BONUS:
                ...
                System.out.println("Количество бонусных баллов: " + (weight * coefficient) + ".");
                break;
            default:
    ...
    // static — метод вызывается из другого статического метода
